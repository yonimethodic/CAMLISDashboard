<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/ModuleMaster.master" AutoEventWireup="true" CodeFile="VLLabSummaryReport.aspx.cs" Inherits="CHAI.LISDashboard.Modules.Report.Views.VLLabSummaryReport" %>
...
.item-3 { 
 ...
 height:35px
        ...
        #DefaultContent_CRVLLabSummary__UI {
            overflow: hidden;
            position: relative;
            width: 100% !important;
            height: 932px;            
...
<ContentTemplate>--%>
    ...
    <cr:crystalreportviewer id="CRVLLabSummary" runat="server" autodatabind="true" visible="true" />
