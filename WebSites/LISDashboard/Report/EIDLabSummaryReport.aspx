<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/ModuleMaster.master" AutoEventWireup="true" CodeFile="EIDLabSummaryReport.aspx.cs" Inherits="CHAI.LISDashboard.Modules.Report.Views.EIDLabSummaryReport" %>
...
.item-3 { 
 ...
 height:35px
        ...
        #DefaultContent_CREIDLabSummary__UI {
            overflow: hidden;
            position: relative;
            width: 100% !important;
            height: 932px;            
...
<ContentTemplate>--%>
    ...
    <cr:crystalreportviewer id="CREIDLabSummary" runat="server" autodatabind="true" visible="true" />
