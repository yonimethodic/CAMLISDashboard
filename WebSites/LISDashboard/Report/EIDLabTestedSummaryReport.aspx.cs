...
{
    public partial class EIDLabTestedSummaryReport : POCBasePage, IDefaultView
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                ReportDocument doc = (ReportDocument)Session["ReportDocument"];
                CREIDTestedSummary.ReportSource = doc;
            }
        }
        ...
        public override string PageID
        {
            ...
            get
            {
                return "{e9d228d3-f9f5-4856-b680-05519fe7a2b6}";
            }
        }
        [CreateNew]
        ...
        private void LoadReport()
        {
            try
            {
                ...
                string TestedFrom = string.Empty, TestedTo = string.Empty;
                ...
                if (rdbDate.SelectedValue == "Collection")
                {
                    CollectFrom = DateFrom;
                    CollectTo = DateTo;
                    PrDateDescription = "Sample Collection Date";
                }
                else if (rdbDate.SelectedValue == "Received")
                {
                    ReceiveFrom = DateFrom;
                    ReceiveTo = DateTo;
                    PrDateDescription = "Sample Received Date";
                }
                else //if (rdbDate.SelectedValue == "Tested")
                {
                    TestedFrom = DateFrom;
                    TestedTo = DateTo;
                    PrDateDescription = "Test Date";
                }
                ...
                var path = Server.MapPath(Convert.ToString("~/Report/EIDLabTestedSummaryReport.rpt"));
                var dsVLSummaryOT = dao.EIDTestedSummary(
                    0, CurrentUser.Id, CurrentUser.AppUserRoles[0].Role.Name,
                    ReceiveFrom, ReceiveTo, CollectFrom, CollectTo, TestedFrom, TestedTo, ProvinceId, FacilityType1, ddlLab.SelectedValue);

                DataSet ds = new DataSet();

                DataTable dtVLSummaryOT = dsVLSummaryOT.Tables[0].Copy();
                dtVLSummaryOT.TableName = "EIDTestedSummaryReport";
                ...
                CREIDTestedSummary.ReportSource = rprt;
                CREIDTestedSummary.ToolPanelView = CrystalDecisions.Web.ToolPanelViewType.None;
