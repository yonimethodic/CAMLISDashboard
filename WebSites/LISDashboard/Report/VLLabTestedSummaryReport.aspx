<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/ModuleMaster.master" AutoEventWireup="true" CodeFile="VLLabTestedSummaryReport.aspx.cs" Inherits="CHAI.LISDashboard.Modules.Report.Views.VLLabTestedSummaryReport" %>
...
.item-3 { 
 ...
 height:35px
        ...
        #DefaultContent_CRVLTestedSummary__UI {
            overflow: hidden;
            position: relative;
            width: 100% !important;
            height: 932px;            
...
<ContentTemplate>--%>
                                        ...
                                        <tr>                            
                                             <td  style=" padding: 2px" align="left" >                       
                                                 <div style="BORDER: thin solid; OVERFLOW: auto; WIDTH: 200px; HEIGHT: 100px"> 
                                                    <%--<asp:CheckBoxList ID="ddlProvince" runat="server" AutoPostBack="false" DataTextField="ProvinceName" DataValueField="Id" >
                                                    </asp:CheckBoxList>--%>
    ...
    <cr:crystalreportviewer id="CRVLTestedSummary" runat="server" autodatabind="true" visible="true" />
