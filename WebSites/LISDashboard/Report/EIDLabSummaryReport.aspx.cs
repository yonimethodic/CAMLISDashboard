...
{
    public partial class EIDLabSummaryReport : POCBasePage, IDefaultView
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                ReportDocument doc = (ReportDocument)Session["ReportDocument"];
                CREIDLabSummary.ReportSource = doc;
            }
        }
        ...
        public override string PageID
        {
            ...
            get
            {
                return "{0537e942-5b57-4aee-a5c7-c2b707037313}";
            }
        }
        [CreateNew]
        ...
        private void LoadReport()
        {
            try
            {
                ...
                var path = Server.MapPath(Convert.ToString("~/Report/EIDLabSummaryReport.rpt"));
                var dsVLSummaryOT = dao.EIDSummary(
                ...
                dtVLSummaryOT.TableName = "EIDLabSummaryReport";
                ...
                CREIDLabSummary.ReportSource = rprt;
                CREIDLabSummary.ToolPanelView = CrystalDecisions.Web.ToolPanelViewType.None;
