<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/ModuleMaster.master" AutoEventWireup="true" CodeFile="EIDLabTestedSummaryReport.aspx.cs" Inherits="CHAI.LISDashboard.Modules.Report.Views.EIDLabTestedSummaryReport" %>
...
.item-3 { 
 ...
 height:35px
        ...
        #DefaultContent_CREIDTestedSummary__UI {
            overflow: hidden;
            position: relative;
            width: 100% !important;
            height: 932px;            
...
<ContentTemplate>--%>
			...
			<!-- Widget ID (each widget will need unique ID)-->   
               <div class="jarviswidget jarviswidget-color-blue" id="wid-id-0" data-widget-editbutton="false">
                    <header>
                        ...
                        <h2>EID Initial Tested Summary</h2>
                    </header>
                   <div>
                    ...
                    <tr>                         
                        <td colspan="2" style=" padding: 2px"  >                            
                            <asp:RadioButtonList ID="rdbDate" runat="server" AutoPostBack="False"  RepeatDirection="Horizontal" >                                     
                                <asp:ListItem Value="Received" Selected="True">Sample Received Date</asp:ListItem>                                        
                                <asp:ListItem Value="Collection" >Sample Collection Date</asp:ListItem>
                                <asp:ListItem Value="Tested">Tested Date</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>                    
                    <tr>                         
    ...
    <cr:crystalreportviewer id="CREIDTestedSummary" runat="server" autodatabind="true" visible="true" />
