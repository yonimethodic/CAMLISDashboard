<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/ModuleMaster.master" AutoEventWireup="true" CodeFile="VLTestByAgeOutcomeReport.aspx.cs" Inherits="CHAI.LISDashboard.Modules.Report.Views.VLTestByAgeOutcomeReport" %>
...
.item-3 { 
 ...
 height:35px
        ...
        #DefaultContent_CRVLTestByAgeOutcome__UI {
            overflow: hidden;
            position: relative;
            width: 100% !important;
            height: 932px;            
...
<ContentTemplate>--%>
    ...
    <cr:crystalreportviewer id="CRVLTestByAgeOutcome" runat="server" autodatabind="true" visible="true" />    
