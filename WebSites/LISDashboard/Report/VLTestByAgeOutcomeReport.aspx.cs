...
{
    public partial class VLTestByAgeOutcomeReport : POCBasePage, IDefaultView
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                ReportDocument doc = (ReportDocument)Session["ReportDocument"];
                CRVLTestByAgeOutcome.ReportSource = doc;
            }
        }
        ...
        public override string PageID
        {
            ...
            get
            {
                return "{5fde0c8f-2a0a-4ca9-a305-5e6fff2dff3f}";
            }
        }
        [CreateNew]
        ...
        //        if (txtSrchNotDate.Text != "") DateFrom = ChangeDateFormat(txtSrchNotDate.Text);
        //        if (txtSrchNotDateTo.Text != "") DateTo = ChangeDateFormat(txtSrchNotDateTo.Text);
        ...
        //        var path = Server.MapPath(Convert.ToString("~/Report/Report1.rpt"));
        //        //var dsVLSummaryOT = dao.VLTestByAgeOutcome(
        ...
        //        //dtVLSummaryOT.TableName = "VLTestByAgeOutcomeReport";
        //        dt.TableName = "dtTestList";
        ...
        //        CRVLTestByAgeOutcome.ReportSource = rprt;
        //        CRVLTestByAgeOutcome.ToolPanelView = CrystalDecisions.Web.ToolPanelViewType.None;
        ...
        private void LoadReport()
        {
            try
            {
                ...
                var path = Server.MapPath(Convert.ToString("~/Report/VLTestByAgeOutcomeReport.rpt"));
                var dsVLSummaryOT = dao.VLTestByAgeOutcome(
                    0, CurrentUser.Id, CurrentUser.AppUserRoles[0].Role.Name,
                    ReceiveFrom, ReceiveTo, CollectFrom, CollectTo, ProvinceId, FacilityType1, ddlLab.SelectedValue);
