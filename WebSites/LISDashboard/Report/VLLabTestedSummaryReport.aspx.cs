...
{
    public partial class VLLabTestedSummaryReport : POCBasePage, IDefaultView
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                ReportDocument doc = (ReportDocument)Session["ReportDocument"];
                CRVLTestedSummary.ReportSource = doc;
            }
        }
        ...
        private void LoadReport()
        {
            try
            {
                ...
                var dsVLSummaryOT = dao.VLTestedSummary(
                ...
                CRVLTestedSummary.ReportSource = rprt;                
                CRVLTestedSummary.ToolPanelView = CrystalDecisions.Web.ToolPanelViewType.None;
