...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoleEdit.aspx.cs" Inherits="CHAI.LISDashboard.Modules.Admin.Views.RoleEdit"
...
<div class="row">
			...
			<asp:Button id="btnDelete" runat="server" Text="Delete" causesvalidation="false" Cssclass="btn btn-primary"></asp:Button>
			</footer>
        </div>
                                </div>
                                </div></div>
