	...
	public partial class TaskpanEdit : Microsoft.Practices.CompositeWeb.Web.UI.Page, ITaskpanEditView
	{
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Master.TransferMessage(new AppMessage("Task pan was saved successfully", CHAI.LISDashboard.Enums.RMessageType.Info));
                ...
                {
                    Master.ShowMessage(new AppMessage("Task pan was saved successfully", CHAI.LISDashboard.Enums.RMessageType.Info));
                }
            }
            catch (Exception ex)
            {
                Master.ShowMessage(new AppMessage("Error: Unable to save Tab. " + ex.Message, CHAI.LISDashboard.Enums.RMessageType.Error));
            }
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _presenter.DeleteIt();
                Master.TransferMessage(new AppMessage("Task pan was deleted successfully", CHAI.LISDashboard.Enums.RMessageType.Info));
                _presenter.Navigate(url);
            }
            catch (Exception ex)
            {
                Master.ShowMessage(new AppMessage("Error: Unable to delete Task pan." + ex.Message, CHAI.LISDashboard.Enums.RMessageType.Error));
            }
        }
