<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/ModuleMaster.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="CHAI.LISDashboard.Modules.ViralLoad.Views.Default" %>
								...
								<div>
                                    ...
                                    <%--<div class="widget-body">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
													...
													<div class="col-md-4">
                                                        ...
                                                        DataTextField="ProvinceName" DataValueField="Id" ValidationGroup="1">
                                        ...
                                        <table style="width: 100%;">
                                            ...
                                            <tr>
                                                <td style="width: 120px; padding: 2px" align="left">
                                                    <asp:Label ID="lblARTNumber" runat="server" CssClass="label" Text="ART Number"></asp:Label>
                                                </td>
                                                <td style="width: 200px;padding: 2px" align="left">
                                                    <asp:TextBox ID="txtARTNumber" runat="server" CssClass="textbox" Width="100%"></asp:TextBox>
                                                </td>                                                
                                                <td style="width: 150px; padding: 2px" align="left">
                                                    <asp:Label ID="lblPatientType" runat="server" CssClass="label" Text="Patient Type"></asp:Label></td>
                                                <td class="editDropDown" style="width: 200px; padding: 2px" align="left">
                                                    <asp:DropDownList ID="ddlPatientType" runat="server" AppendDataBoundItems="True" Height="26px" Width="100%" AutoPostBack="false">
                                                        <asp:ListItem Value="0">All</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                                <td style="padding: 2px" align="left">                                                    
