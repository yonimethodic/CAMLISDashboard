...
{
   public static class CryptographyHelper1
    {
       ...
       public static string Decrypt(string encryptedText)
       {
           ...
           GetKeyFromEncryptionString(PrivateKey, out keySize, out publicAndPrivateKeyXml);
            ...
            //var decrypted = Decrypt(Convert.FromBase64String(value), keySize, publicAndPrivateKeyXml);

            //encryptedText = encryptedText.Replace('-', '+');
            //encryptedText = encryptedText.Replace('_', '/');
            //byte[] temp = Convert.FromBase64String(encryptedText);
            //byte[] byt = Encoding.ASCII.GetBytes(encryptedText);
