...
namespace CHAI.LISDashboard.CoreDomain.Infrastructure
{
    public class BaseDbContext : DbContext
    {
        ...
        public int ExecuteFunction(string functionName, params SqlParameter[] parameters)
        {
            
            return ObjContext().ExecuteStoreCommand(functionName, parameters);
        }
    }
}
